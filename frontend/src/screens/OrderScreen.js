...
const OrderScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    ...
    if (!order || successPay || successShipped || order._id !== orderId) {
  ...
  }, [dispatch, orderId, successPay, successShipped, order, history, userInfo])
            ...
            <ListGroup variant='flush'>
              <ListGroup.Item>
                ...
                <p>
                  ...
                  {order.user.name} <br />
                  <strong>Email: </strong>
                  <a href={`order.user.email`}>{order.user.email}</a> <br />
